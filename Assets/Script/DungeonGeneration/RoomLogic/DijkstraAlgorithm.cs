...
public class DijkstraAlgorithm
{
    public static Dictionary<Vector2Int, int> Dijkstra(Graph graph, Vector2Int startposition)
    {
        ...
        foreach (Vector2Int vertex in graph.GetNeighboursBasicDirections(startposition))
        {
        ...
        while (unfinishedVertices.Count > 0)
        {
            ...
            foreach (Vector2Int neighbour in graph.GetNeighboursBasicDirections(vertex))
            {
